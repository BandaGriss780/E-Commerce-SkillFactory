              ...
              <div className="card-body">
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <div className="d-flex justify-content-evenly">
                    <button type="submit button" className="btn btn-outline-dark">Sign in <i className="bi bi-check"></i></button>
                    <button className="btn btn-outline-dark" onClick={onGoogleSignIn}><i className="bi bi-google"></i> Google</button>
                    <button className="btn btn-outline-dark" onClick={onGithubSignIn}><i className="bi bi-github"></i> Github</button>
                    <Link className="btn btn-outline-dark" component={RouterLink} color="inherit" to='/auth/register'>
